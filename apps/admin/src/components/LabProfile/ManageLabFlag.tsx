import { Divider, Stack, Button, Box, InputAdornment, Typography, TextField, MenuItem, Container, Grid, IconButton, } from '@mui/material';
...
const ManageLabFlag: FC<ManageLabBasicDetailsProps> = ({ data }) => {
    ...
    const {
        ...
        defaultValues: {
            flag: data?.flag?.map(item => ({ flag: item.flag, type: item.type, id: item.id })) || [],
        },
    });
                ...
                <FormElementWithLabel
                    ...
                    value={editMode ? (
                        ...
                        <Container disableGutters>
                            ...
                            <Button sx={{ width: 'fit-content' }} variant="contained" onClick={()=>append({ flag: "", type: "" })}>
                                Add Flag
                            </Button>
                        </Container>
                    ) : (
